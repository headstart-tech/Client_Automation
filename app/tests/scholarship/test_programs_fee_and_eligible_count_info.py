"""
This file contains test cases of get programs fee and eligible count information.
"""
import pytest
...
@pytest.mark.asyncio
async def test_get_programs_fee_and_eligible_count_info(
    ...
    """
    Different test cases of get programs fee and eligible count information.
    ...
    # Not authenticated for get programs fee and eligible count information.
    response = await http_client_test.post(f"/scholarship/programs_fee_and_eligible_count_info/"
                                           f"?college_id={college_id}&feature_key={feature_key}")
    assert response.status_code == 401
    assert response.json()["detail"] == "Not authenticated"

    # Bad token for get programs fee and eligible count information.
    response = await http_client_test.post(
        f"/scholarship/programs_fee_and_eligible_count_info/?college_id={college_id}&feature_key={feature_key}",
        headers={"Authorization": f"Bearer wrong"}
    )
    assert response.status_code == 401
    assert response.json() == {"detail": "Could not validate credentials"}

    # Field required for get programs fee and eligible count information.
    response = await http_client_test.post(
        f"/scholarship/programs_fee_and_eligible_count_info/?college_id={college_id}&feature_key={feature_key}",
    ...
    # No permission for get programs fee and eligible count information.
    response = await http_client_test.post(
        f"/scholarship/programs_fee_and_eligible_count_info/?college_id={college_id}&feature_key={feature_key}",
        headers={"Authorization": f"Bearer {access_token}"},
    ...
    # Get programs fee and eligible count information.
    ...
    assert "eligible_applicants_count" in response.json()
    assert "programs_fee_info" in response.json()

    # Invalid college id for get programs fee and eligible count information.
    response = await http_client_test.post(
        f"/scholarship/programs_fee_and_eligible_count_info/?college_id=123&feature_key={feature_key}",
        headers={"Authorization": f"Bearer {college_super_admin_access_token}"},
        json=test_create_scholarship_data
    )
    ...
    # Wrong college id for get programs fee and eligible count information.
    response = await http_client_test.post(
        f"/scholarship/programs_fee_and_eligible_count_info/?college_id=123456789012345678901234"
    ...
    # Wrong college id for get programs fee and eligible count information.
    response = await http_client_test.post(
        f"/scholarship/programs_fee_and_eligible_count_info/?feature_key={feature_key}",
        headers={"Authorization": f"Bearer {college_super_admin_access_token}"},
        json=test_create_scholarship_data
    )
    assert response.status_code == 400
    ...
    # Invalid scholarship name when get programs fee and eligible count information.
    ...
    # Invalid course id when get programs fee and eligible count information.
    ...
    # Course not found when get programs fee and eligible count information.
    ...
    # Invalid course name when get programs fee and eligible count information.
    ...
    # Invalid specialization name when get programs fee and eligible count information.
    ...
    # Invalid template id when get programs fee and eligible count information.
    test_create_scholarship_data.get("programs", {})[0].update(
        {"course_name": test_course_validation.get("course_name"),
    ...
    # Get programs fee and eligible count information by passing template information.
    ...
    # Invalid scholarship percentage of scholarship when get programs fee and eligible count information.
    ...
    assert response.status_code == 400
    assert response.json()['detail'] == "Scholarship percentage should be less than or equal to 100."

    # Invalid scholarship amount of scholarship when get programs fee and eligible count information.
    ...
    # Invalid scholarship id when get programs fee and eligible count information.
    test_create_scholarship_data.update({"copy_scholarship_id": "1234567890", "name": "test11",
                                         "waiver_type": "Percentage", "waiver_value": 100})
    response = await http_client_test.post(
        f"/scholarship/programs_fee_and_eligible_count_info/?college_id={college_id}&feature_key={feature_key}",
        headers={"Authorization": f"Bearer {college_super_admin_access_token}"},
        json=test_create_scholarship_data
    ...
    # Invalid status of scholarship when get programs fee and eligible count information.
    ...
    # Invalid waiver_value of scholarship when get programs fee and eligible count information.
    ...
    # Invalid waiver_type of scholarship when get programs fee and eligible count information.
    ...
    # Invalid count of scholarship when get programs fee and eligible count information.
    ...
    # Invalid name of scholarship when get programs fee and eligible count information.
    ...
    # Invalid programs when get programs fee and eligible count information.
