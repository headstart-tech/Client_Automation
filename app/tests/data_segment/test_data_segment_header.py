...
@pytest.mark.asyncio
async def test_data_segment_header_not_authenticated(http_client_test,
...
@pytest.mark.asyncio
async def test_data_segment_header_bad_credentials(
        http_client_test,
...
@pytest.mark.asyncio
async def test_data_segment_header_field_required(
...
@pytest.mark.asyncio
async def test_data_segment_header_invalid_id(
        http_client_test,
        test_create_data_segment_helper,
        test_college_validation,
