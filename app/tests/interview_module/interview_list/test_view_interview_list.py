...
@pytest.mark.asyncio
async def test_view_interview_list_no_authentication(
        http_client_test, test_interview_list_validation,
        test_college_validation, setup_module):
    """
        View interview list by not authenticated users.
    ...
    response = await http_client_test.post(
        f"/interview/view_interview_detail/"
        f"?interview_list_id={str(test_interview_list_validation.get('_id'))}&feature_key={feature_key}"
...
@pytest.mark.asyncio
async def test_view_interview_list_no_permission(
        http_client_test, test_interview_list_validation,
        test_college_validation, setup_module,
        access_token):
    """
        View interview list by no permission users.
...
@pytest.mark.asyncio
async def test_view_interview_list_invalid_id(
        http_client_test, test_interview_list_validation,
        test_college_validation, setup_module,
        college_super_admin_access_token):
    """
        View interview list with invalid id.
...
@pytest.mark.asyncio
async def test_view_interview_list_found(
        http_client_test, test_interview_list_validation,
        test_college_validation, setup_module,
        college_super_admin_access_token):
    """
        View interview list application found.
