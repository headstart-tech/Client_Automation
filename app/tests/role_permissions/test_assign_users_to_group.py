"""
Unit tests for the `/group/add_user/` endpoint in the Role Permissions module.
...
from app.tests.conftest import fetch_unassigned_group_users
from app.tests.conftest import user_feature_data

feature_key = user_feature_data()

@pytest.mark.asyncio
async def test_add_user_without_token(http_client_test):
    """
    Handles unit test for the `/group/add_user/` endpoint when called with no authorization token.
    """
    response = await http_client_test.post(
        f"/role_permissions/group/add_user/1?feature_key={feature_key}",
...
@pytest.mark.asyncio
async def test_add_user_with_invalid_token(http_client_test, invalid_token):
    """
    Handles unit test for the `/group/add_user/` endpoint when called with an invalid authorization token.
    """
...
async def test_add_user_without_headers(http_client_test):
    """
    Handles unit test for the `/group/add_user/` endpoint when called with an invalid authorization token.
    """
...
@pytest.mark.asyncio
async def test_add_user_without_request_body(http_client_test, super_admin_token):
    """
    Handles unit test for the `/group/add_user/` endpoint when called without request body.
    """
...
# Todo: Need to add updated testcases for assign_users to group
...
#         ),  # test "/group/add_user/" with invalid id and valid json
#         (
#             "ID",
#             "Permission list",
#             400,
#             "Group Id must be required and valid.",
#         ),  # test "/group/add_user/" with invalid id and invalid json
#         (
#             0,
#             None,
#             400,
#             "Group Id must be required and valid.",
#         ),  # test "/group/add_user/" with invalid id and None json
#         (
#             None,
#             [],
#             400,
#             "Group Id must be required and valid.",
#         ),  # test "/group/add_user/" with None id and valid json
#         (
#             None,
#             False,
#             400,
#             "Group Id must be required and valid.",
#         ),  # test "/group/add_user/" with None id and invalid json
#         (
#             None,
#             None,
#             400,
#             "Group Id must be required and valid.",
#         ),  # test "/group/add_user/" with None id and None json
#         (
#             1,
#             "Permission list",
#             400,
#             "User Ids must be required and valid.",
#         ),  # test "/group/add_user/" with valid id and invalid json
#     ],
# )
# async def test_add_user_for_invalid_data(
#     http_client_test,
#     super_admin_token,
#     user_token,
#     group_id,
...
#     """
#
#     # testing "/group/add_user/" with "super_admin_token"
#     response = await http_client_test.post(
#         f"/role_permissions/group/add_user/{group_id}",
#         headers={"Authorization": f"Bearer {super_admin_token}"},
...
#
#     # testing "/group/add_user/" with "user_token"
#     response = await http_client_test.post(
#         f"/role_permissions/group/add_user/{group_id}",
...
# async def test_add_user_with_valid_data(
...
#     user_id = await fetch_unassigned_group_users("group", group_id)
#
...
#     assert response.json()["message"] == "Users were successfully added."
#
...
#     )
#     assert response.status_code == 200
#     assert response.json()["message"] == "No users were added."
#
