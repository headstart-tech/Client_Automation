"""
Unit tests for the `/role_permissions/roles` endpoint.

This module tests the role retrieval API with different scenarios, including:
...
@pytest.mark.asyncio
async def test_get_roles_without_token(http_client_test):
    """
    Handles unit test for the `roles` endpoint when called with no authorization token.
    """
    response = await http_client_test.get(
        f"/role_permissions/roles?page_num=1&page_size=10&feature_key={feature_key}",
...
async def test_get_role_with_invalid_token(http_client_test, invalid_token):
    """
    Handles unit test for the `roles` endpoint when called with an invalid authorization token.
    """

    response = await http_client_test.get(
        f"/role_permissions/roles?feature_key={feature_key}",
...
@pytest.mark.asyncio
async def test_get_roles_without_headers(http_client_test):
    """
    Handles a unit test for the `roles` endpoint when called without headers.
    """
    response = await http_client_test.get(
        f"/role_permissions/roles?feature_key={feature_key}",
    )
...
# Todo: Need to add updated testcases for get_role
...
#         ),  # test 'roles' with valid page_num and invalid page_size
#         (
#             1,
#             None,
#             400,
#             "Page Size must be required and valid.",
#         ),  # test 'roles' with valid page_num and no page_size
#         (
#             "one",
#             10,
#             400,
#             "Page Num must be required and valid.",
#         ),  # test 'roles' with invalid page_num and valid page_size
#         (
#             "one",
#             "ten",
#             400,
#             "Page Num must be required and valid.",
#         ),  # test 'roles' with invalid page_num and invalid page_size
#         (
#             "one",
#             None,
#             400,
#             "Page Num must be required and valid.",
#         ),  # test 'roles' with invalid page_num and no page_size
#         (
#             None,
#             10,
#             400,
#             "Page Num must be required and valid.",
#         ),  # test 'roles' with no page_num and valid page_size
#         (
#             None,
#             "ten",
#             400,
#             "Page Num must be required and valid.",
#         ),  # test 'roles' with no page_num and invalid page_size
#         (
#             None,
#             None,
#             400,
#             "Page Num must be required and valid.",
#         ),  # test 'roles' with no page_num and no page_size
#         (
#             1,
#             10,
#             200,
#             "Roles Fetched Successfully",
#         ),  # test 'roles' with valid page_num and valid page_size
#     ],
# )
# @pytest.mark.asyncio
...
# ):
#     """
#     Test the /role_permissions/roles endpoint.
#
#     Validates role retrieval with pagination for Super Admin and regular users.
...
#     response = await http_client_test.get(
#         f"/role_permissions/roles?page_num={page_num}&page_size={page_size}",
