"""
This file contains test cases regarding for get event data by name or id
"""
import pytest
...
@pytest.mark.asyncio
async def test_get_event_data_by_name_or_id_not_authenticated(http_client_test, test_college_validation, setup_module):
    """
    Not authenticated if user not logged in
    """
    response = await http_client_test.get(
        f"/event/get_by_name_or_id/?college_id={test_college_validation.get('_id')}&feature_key={feature_key}")
    assert response.status_code == 401
    assert response.json()["detail"] == "Not authenticated"


@pytest.mark.asyncio
async def test_get_event_data_by_name_or_id_bad_credentials(http_client_test, test_college_validation, setup_module):
    """
    Bad token for get event data by name or id
    """
    response = await http_client_test.get(
        f"/event/get_by_name_or_id/?college_id={test_college_validation.get('_id')}&feature_key={feature_key}",
...
@pytest.mark.asyncio
async def test_get_event_data_by_name_or_id_field_required(
        http_client_test, test_college_validation, access_token, setup_module
):
    """
    Field required for get event data by name or id
    """
    response = await http_client_test.get(
        f"/event/get_by_name_or_id/?feature_key={feature_key}", headers={"Authorization": f"Bearer {access_token}"}
    )
...
@pytest.mark.asyncio
async def test_get_event_data_by_name_or_id_no_permission(
        http_client_test, test_college_validation, access_token, test_campaign_data, setup_module
):
    """
    No permission for get event data by name or id
    """
    response = await http_client_test.get(
        f"/event/get_by_name_or_id/?college_id={test_college_validation.get('_id')}&feature_key={feature_key}",
...
@pytest.mark.asyncio
async def test_get_event_data_by_name_or_id_required_event_name_or_id(
        http_client_test, test_college_validation, college_super_admin_access_token, test_create_data_segment,
        setup_module
):
    """
    Required event name or id for get event data by name or id
    """
    response = await http_client_test.get(
        f"/event/get_by_name_or_id/?college_id={test_college_validation.get('_id')}&feature_key={feature_key}",
...
@pytest.mark.asyncio
async def test_get_event_data_by_name_or_id_by_invalid_id(
        http_client_test, test_college_validation, college_super_admin_access_token, test_create_data_segment,
        setup_module
):
    """
    ...
    """
    response = await http_client_test.get(
        f"/event/get_by_name_or_id/?college_id={test_college_validation.get('_id')}"
...
@pytest.mark.asyncio
async def test_get_event_data_by_name_or_id_invalid_college_id(
    ...
    """
    response = await http_client_test.get(
        f"/event/get_by_name_or_id/?college_id=1234567890&event_id=123456789012345678901234"
...
@pytest.mark.asyncio
async def test_get_event_data_by_name_or_id(
        http_client_test, test_college_validation, college_super_admin_access_token, test_create_data_segment,
    ...
    assert response.status_code == 200
    assert response.json()['message'] == "Get event data."
